...
* More on this, I found that the **lower frequency channels** typically sound better than the higher frequency channels, you can play around  
...
* I think the channel distribution and the number of channels that we have will make the biggest difference. Already modifying this myself  
leads to much, much better results than what we had previously (we started with 12 channels). That being said, I don't think changing the specific  
